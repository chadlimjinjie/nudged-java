...
public class MapTransformer {
	...
	public MapTransformer(ArrayList<Point> robot_map_pts, ArrayList<Point> rmf_map_pts) {
		trans = estimate(robot_map_pts, rmf_map_pts);
		rotation = trans.get_rotation();
		scale = trans.get_scale();
		matrix = trans.get_matrix();
		translation = trans.get_translation();
	};

	public Transform estimate(ArrayList<Point> domainPoints, ArrayList<Point> rangePoints) {
	 ...
	 */
	public Point transform_position(double x, double y) {
		Point trans_pt = trans.transform_one(new Point(x, y));
		return trans_pt;
	}
	 ...
	 */
	public double transform_heading(double heading) {
